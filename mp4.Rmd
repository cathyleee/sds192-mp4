...
From the IMDB movie database, we pulled data including movie ID, title, production year, genre, budget, and gross revenue of the movies that were produced by US companies after 1980, had budgets in USD and gross revenues from the US market. We pulled another data frame about gender and role of each person in the crew (including actors/actresses) of each movie that met the same criteria as listed above. The last data frame that we extracted from the database is specifically about ther personnel of the "production team" (director, producer, writer) and the budget of each movie that we filtered above. 
